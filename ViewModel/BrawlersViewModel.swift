...
//    @Published var brawlers: [Brawler] = [] // 로딩 후 데이터
    ...
    //신화 브롤러
    @Published var mythic = ["BUSTER","BUZZ","BYRON","CHARLIE","CHUCK","CLANCY","DOUG","EVE","FANG","GENE","GRAY","JANET","JUJU","LILY","LOU","MAX","MELODIE","MICO","MOE","MORTIS","MR. P","OTIS","R-T","RUFFS","SPROUT","SQUEAK","TARA","WILLOW", "OLLIE"]
    ...
    @Published var tanker_brawlers_standard = [
        ...
        Brawler_standard(name: "HANK", first_gadget: "WATER BALLOONS", second_gadget: "BARRICADE", first_starPower: "IT'S GONNA BLOW", second_starPower: "TAKE COVER!", hypercharge: ""),
    ...
    @Published var assassin_brawlers_standard = [
        ...
        Brawler_standard(name: "SAM", first_gadget: "MAGNETIC FIELD", second_gadget: "PULSE REPELLENT", first_starPower: "HEARTY RECOVERY", second_starPower: "REMOTE RECHARGE", hypercharge: ""),
    ...
    @Published var controller_brawlers_standard = [
        ...
        Brawler_standard(name: "GRIFF", first_gadget: "PIGGY BANK", second_gadget: "COIN SHOWER", first_starPower: "KEEP THE CHANGE", second_starPower: "BUSINESS RESILIENCE", hypercharge: ""),
        ...
        Brawler_standard(name: "AMBER", first_gadget: "FIRE STARTERS", second_gadget: "DANCING FLAMES", first_starPower: "WILD FLAMES", second_starPower: "SCORCHIN' SIPHON", hypercharge: ""),
    ]
    ...
    @Published var damage_dealers_brawlers_standard = [
        ...
        Brawler_standard(name: "CLANCY", first_gadget: "SNAPPY SHOOTING", second_gadget: "TACTICAL RETREAT", first_starPower: "RECON", second_starPower: "PUMPING UP", hypercharge: ""),
    ...
    @Published var throw_brawlers_standard = [
        ...
        Brawler_standard(name: "GROM", first_gadget: "WATCHTOWER", second_gadget: "RADIO CHECK", first_starPower: "FOOT PATROL", second_starPower: "X-FACTOR", hypercharge: ""),
