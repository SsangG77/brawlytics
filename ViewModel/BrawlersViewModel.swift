...
//    @Published var brawlers: [Brawler] = [] // 로딩 후 데이터
    ...
    @Published var assassin_brawlers_standard = [
        ...
        Brawler_standard(name: "MELODIE", first_gadget: "PERFECT PITCH", second_gadget: "INTERLUDE", first_starPower: "FAST BEATS", second_starPower: "EXRENDED MIX", hypercharge: "FLASH MOB"),
    ...
    @Published var damage_dealers_brawlers_standard = [
        ...
        Brawler_standard(name: "EVE", first_gadget: "GOTTA GO!", second_gadget: "MOTHERLY LOVE", first_starPower: "UNNATURAL ORDER", second_starPower: "HAPPY SUPRISE", hypercharge: "Generations"),
