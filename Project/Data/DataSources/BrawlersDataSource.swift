...
class BrawlersDataSource: ObservableObject {
    @Published var allBrawlers = [
        ...
        BrawlerStandard(name: "SHADE", first_gadget: "LONGARMS", second_gadget: "JUMP SCARE", first_starPower: "SPOOKY SPEEDSTER", second_starPower: "HARDENED HOODIE", hypercharge: "", rarity: .epic, role: .assassin, epicGear: .none, mythicGear: .none),
        ...
        BrawlerStandard(name: "BYRON", first_gadget: "SHOT IN THE ARM", second_gadget: "BOOSTER SHOTS", first_starPower: "MALAISE", second_starPower: "INJECTION", hypercharge: "", rarity: .mythic, role: .supporter, epicGear: .none, mythicGear: .none),
        ...
        BrawlerStandard(name: "DOUG", first_gadget: "DOUBLE SAUSAGE", second_gadget: "EXTRA MUSTARD", first_starPower: "FAST FOOD", second_starPower: "SELF SERVICE", hypercharge: "", rarity: .mythic, role: .supporter, epicGear: .none, mythicGear: .none),
        BrawlerStandard(name: "KIT", first_gadget: "CARDBOARD BOX", second_gadget: "CHEESEBURGER", first_starPower: "POWER HUNGRY", second_starPower: "OVERLY ATTACHED", hypercharge: "", rarity: .legendary, role: .supporter, epicGear: .none, mythicGear: .none),
        BrawlerStandard(name: "JAE-YONG", first_gadget: "WEEKEND WARRIOR", second_gadget: "TIME FOR A SLOW SONG", first_starPower: "THE CROWD GOES MILD", second_starPower: "EXTRA HIGH NOTE", hypercharge: "", rarity: .mythic, role: .supporter, epicGear: .none, mythicGear: .none),
        ...
        BrawlerStandard(name: "MEEPLE", first_gadget: "MANSIONS OF MEEPLE", second_gadget: "RAGEQUIT", first_starPower: "DO NOT PASS GO", second_starPower: "RULE BENDING", hypercharge: "", rarity: .epic, role: .controller, epicGear: .none, mythicGear: .none),
        ...
        BrawlerStandard(name: "CHUCK", first_gadget: "REROUTING", second_gadget: "GHOST TRAIN", first_starPower: "PIT STOP", second_starPower: "TICKETS PLEASE!", hypercharge: "", rarity: .mythic, role: .controller, epicGear: .none, mythicGear: .none),
        ...
        BrawlerStandard(name: "FINX", first_gadget: "BACK TO THE FINXTURE", second_gadget: "NO ESCAPE", first_starPower: "HIEROGLYPH HALT", second_starPower: "PRIMER", hypercharge: "", rarity: .mythic, role: .controller, epicGear: .none, mythicGear: .none),
        ...
        BrawlerStandard(name: "R-T", first_gadget: "OUT OF LINE", second_gadget: "HACKS!", first_starPower: "QUICK MATHS", second_starPower: "RECORDING", hypercharge: "", rarity: .mythic, role: .damageDealer, epicGear: .none, mythicGear: .none),
        ...
        BrawlerStandard(name: "MOE", first_gadget: "DODGY DIGGING", second_gadget: "RAT RACE", first_starPower: "SKIPPING STONES", second_starPower: "SPEEDING TICKET", hypercharge: "", rarity: .mythic, role: .damageDealer, epicGear: .none, mythicGear: .none),
        ...
        BrawlerStandard(name: "LUMI", first_gadget: "INFERNAL FLAMES", second_gadget: "GRIM AND FROSTBITTEN", first_starPower: "42% BURNT", second_starPower: "HALF TIME", hypercharge: "", rarity: .mythic, role: .damageDealer, epicGear: .none, mythicGear: .none),
        ...
        BrawlerStandard(name: "BONNIE", first_gadget: "SUGAR RUSH", second_gadget: "CRASH TEST", first_starPower: "BLACK POWDER", second_starPower: "WISDOM TOOTH", hypercharge: "", rarity: .epic, role: .marksmen, epicGear: .superCharge, mythicGear: .none),
